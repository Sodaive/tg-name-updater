...
**Telegram Profile Time Updater** یک پروژه سبک و متن‌باز با Node.js است که نام پروفایل شخصی تلگرام شما را به‌صورت خودکار با **ساعت فعلی** به‌روزرسانی می‌کند.
...
Workflow پروژه را انتخاب کرده و:
...
GitHub Actions برای اجرای دقیق و لحظه‌ای طراحی نشده است.
